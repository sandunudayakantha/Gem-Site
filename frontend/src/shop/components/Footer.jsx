    ...
    <footer className="relative bg-black text-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-16 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-16">
              ...
              <div className="space-y-3">
                {settings.contact.email && (
                  <a 
                    ...
                    className="block text-xs text-white/70 hover:text-[#B38728] transition-colors duration-300 font-light tracking-wide"
                  >
                    {settings.contact.email}
                  </a>
                )}
          ...
          {/* Categories Section */}
          <div>
            <h3 className="text-sm font-light tracking-widest uppercase mb-6 pb-2 border-b border-[#B38728]/20 text-white">
              Categories
            </h3>
            <nav className="space-y-3">
              ...
              <Link
                to="/products"
                className="block text-xs text-white/70 hover:text-[#B38728] transition-colors duration-300 font-light tracking-wide mt-4"
              >
                View All →
              </Link>
            </nav>
            ...
            <div className="space-y-4">
              {settings?.contact?.whatsapp && (
                <button
                  ...
                  className="flex items-center gap-3 text-xs text-white/70 hover:text-[#B38728] transition-colors duration-300 font-light tracking-wide group"
                >
